...
</li>`)}),o.innerHTML=i.join(""),n?n.refresh():n=new f(".gallery a",{captionsData:"alt",captionDelay:250,download:!0})}function m(){d.classList.remove("display-none")}function g(){d.classList.add("display-none")}const c=document.querySelector(".form");c.addEventListener("submit",y);function y(r){r.preventDefault(),m();const o=c.elements["search-text"].value;p(o).then(e=>{e.length===0&&l.show({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight",messageColor:"#fff",backgroundColor:"red"}),h(e)}).catch(e=>{l.show({message:`Ooops, something went wrong, try again. ${e}`,position:"topRight",messageColor:"#fff",backgroundColor:"red"})}).finally(()=>{g()}),c.reset()}
